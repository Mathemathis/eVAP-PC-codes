...
class EB:
    ...
    def set_situation_EB_at_t(self, t, parked_at_lane_space_at_t=None, assigned_to_block_at_t=None, is_charged_at_t=None, parked_for_trip_at_t=None):
        ...
        self.parked_for_trip[t] = parked_for_trip_at_t
    ...
    def get_parked_for_trip(self,t):
        if self.is_parked_at_t(t):
            return self.parked_for_trip[t]
        else:
            return None
